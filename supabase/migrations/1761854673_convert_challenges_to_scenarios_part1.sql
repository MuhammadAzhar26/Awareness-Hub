-- Migration: convert_challenges_to_scenarios_part1
-- Created at: 1761854673

-- Transform Module 1-3 text challenges to scenario-based (18 stages)
  ...
  challenge_data = '{
    "sections": [{
      ...
      "options": [
        ...
        {"id": "correct-horse", "text": "correct-horse-battery-staple"}
      ]
    }],
...
UPDATE stages SET 
  ...
  challenge_data = '{
    "sections": [{
      ...
      "options": [
        {"id": "md5", "text": "MD5 hash (32 hex chars)"},
  ...
  challenge_data = '{
    "sections": [{
      ...
      "options": [
        ...
        {"id": "homograph", "text": "Homograph attack"},
